 ...
 <div className="w-12 h-12 rounded-xl flex items-center justify-center hover:rotate-12 transition-transform" style={{ backgroundColor: '#8FC240' + '1A' }}>
      ...
      // /note15-banneroo1.webp
             ...
             // {image:"astro note 13 max.png", name: "Astro Vibe", tag: "Bugdet Range", title: "From $20us + usage top ups"},
              {image:"astro note 15.png", name: "Astro Vibe", tag: "Bugdet Range", title: "From $10us + usage top ups"},
              {image:"astro note 15 pro.png", name: "Astro Nova", tag: "Middle Range", title: "From $20us + usage top ups"},
              {image:"astro note 13 max.png", name: "Astro Prime", tag: "Top Range", title: "From $30us + usage top ups"},
            ].map((product, i) => (
